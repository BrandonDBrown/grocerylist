  ...
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/recipes/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Recipe.account() instead.
            "prototype$__get__account": {
              url: urlBase + "/recipes/:id/account",
              method: "GET",
            },

            // INTERNAL. Use Recipe.items.findById() instead.
            "prototype$__findById__items": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/recipes/:id/items/:fk",
              method: "GET",
            },

            // INTERNAL. Use Recipe.items.destroyById() instead.
            ...
            // INTERNAL. Use Recipe.items.updateById() instead.
            ...
            // INTERNAL. Use Recipe.items() instead.
            "prototype$__get__items": {
              isArray: true,
              url: urlBase + "/recipes/:id/items",
              method: "GET",
            },

            // INTERNAL. Use Recipe.items.create() instead.
            "prototype$__create__items": {
              url: urlBase + "/recipes/:id/items",
              method: "POST",
            },

            // INTERNAL. Use Recipe.items.destroyAll() instead.
            "prototype$__delete__items": {
              url: urlBase + "/recipes/:id/items",
              method: "DELETE",
            },

            // INTERNAL. Use Recipe.items.count() instead.
            "prototype$__count__items": {
              url: urlBase + "/recipes/:id/items/count",
              method: "GET",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recipe#patchOrCreate
             * @methodOf lbServices.Recipe
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recipe#replaceOrCreate
             * @methodOf lbServices.Recipe
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recipe#upsertWithWhere
             * @methodOf lbServices.Recipe
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recipe#replaceById
             * @methodOf lbServices.Recipe
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recipe#prototype$patchAttributes
             * @methodOf lbServices.Recipe
             *
             * @description
             *
            ...
            // INTERNAL. Use Account.recipes.findById() instead.
            "::findById::Account::recipes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/accounts/:id/recipes/:fk",
              method: "GET",
            },

            // INTERNAL. Use Account.recipes.destroyById() instead.
            "::destroyById::Account::recipes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/accounts/:id/recipes/:fk",
            ...
            // INTERNAL. Use Account.recipes.updateById() instead.
            "::updateById::Account::recipes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/accounts/:id/recipes/:fk",
            ...
            // INTERNAL. Use Account.recipes() instead.
            "::get::Account::recipes": {
              isArray: true,
              url: urlBase + "/accounts/:id/recipes",
              method: "GET",
            },

            // INTERNAL. Use Account.recipes.create() instead.
            "::create::Account::recipes": {
              url: urlBase + "/accounts/:id/recipes",
              method: "POST",
            },

            // INTERNAL. Use Account.recipes.createMany() instead.
            "::createMany::Account::recipes": {
              isArray: true,
              url: urlBase + "/accounts/:id/recipes",
              method: "POST",
            },

            // INTERNAL. Use Account.recipes.destroyAll() instead.
            "::delete::Account::recipes": {
              url: urlBase + "/accounts/:id/recipes",
              method: "DELETE",
            },

            // INTERNAL. Use Account.recipes.count() instead.
            "::count::Account::recipes": {
              url: urlBase + "/accounts/:id/recipes/count",
              method: "GET",
            },

            // INTERNAL. Use Item.recipe() instead.
            "::get::Item::recipe": {
              url: urlBase + "/items/:id/recipe",
              method: "GET",
            },
          }
        );
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recipe#patchOrCreateWithWhere
             * @methodOf lbServices.Recipe
             *
             * @description
             *
        ...
        */
        R.modelName = "Recipe";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Recipe#account
             * @methodOf lbServices.Recipe
             *
             * @description
             *
        ...
        R.account = function() {
          ...
          var action = TargetResource["::get::Recipe::account"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Recipe.items
     * @header lbServices.Recipe.items
     * @object
     * @description
     *
     * The object `Recipe.items` groups methods
     * manipulating `Item` instances related to `Recipe`.
     *
     * Call {@link lbServices.Recipe#items Recipe.items()}
     ...
     */
        ...
        R.items = function() {
          ...
          var action = TargetResource["::get::Recipe::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Recipe.items#count
             * @methodOf lbServices.Recipe.items
             *
             * @description
             *
             * Counts items of recipe.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - recipe id
        ...
        R.items.count = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::count::Recipe::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Recipe.items#create
             * @methodOf lbServices.Recipe.items
             *
             * @description
             *
        ...
        R.items.create = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::create::Recipe::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Recipe.items#createMany
             * @methodOf lbServices.Recipe.items
             *
             * @description
             *
        ...
        R.items.createMany = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::createMany::Recipe::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Recipe.items#destroyAll
             * @methodOf lbServices.Recipe.items
             *
             * @description
             *
        ...
        R.items.destroyAll = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::delete::Recipe::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Recipe.items#destroyById
             * @methodOf lbServices.Recipe.items
             *
             * @description
             *
        ...
        R.items.destroyById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::destroyById::Recipe::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Recipe.items#findById
             * @methodOf lbServices.Recipe.items
             *
             * @description
             *
        ...
        R.items.findById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::findById::Recipe::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Recipe.items#updateById
             * @methodOf lbServices.Recipe.items
             *
             * @description
             *
        ...
        R.items.updateById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::updateById::Recipe::items"];
          return action.apply(R, arguments);
        };
 ...
 */
  module.factory(
    ...
    /**
     * @ngdoc object
     * @name lbServices.Account.recipes
     * @header lbServices.Account.recipes
     * @object
     * @description
     *
     * The object `Account.recipes` groups methods
     * manipulating `Recipe` instances related to `Account`.
     *
     * Call {@link lbServices.Account#recipes Account.recipes()}
     * to query all related instances.
     */
        ...
        R.recipes = function() {
          ...
          var action = TargetResource["::get::Account::recipes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Account.recipes#count
             * @methodOf lbServices.Account.recipes
             *
             * @description
             *
             * Counts recipes of account.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - account id
        ...
        R.recipes.count = function() {
          var TargetResource = $injector.get("Recipe");
          var action = TargetResource["::count::Account::recipes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Account.recipes#create
             * @methodOf lbServices.Account.recipes
             *
             * @description
             *
        ...
        R.recipes.create = function() {
          var TargetResource = $injector.get("Recipe");
          var action = TargetResource["::create::Account::recipes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Account.recipes#createMany
             * @methodOf lbServices.Account.recipes
             *
             * @description
             *
        ...
        R.recipes.createMany = function() {
          var TargetResource = $injector.get("Recipe");
          var action = TargetResource["::createMany::Account::recipes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Account.recipes#destroyAll
             * @methodOf lbServices.Account.recipes
             *
             * @description
             *
        ...
        R.recipes.destroyAll = function() {
          var TargetResource = $injector.get("Recipe");
          var action = TargetResource["::delete::Account::recipes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Account.recipes#destroyById
             * @methodOf lbServices.Account.recipes
             *
             * @description
             *
        ...
        R.recipes.destroyById = function() {
          var TargetResource = $injector.get("Recipe");
          var action = TargetResource["::destroyById::Account::recipes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Account.recipes#findById
             * @methodOf lbServices.Account.recipes
             *
             * @description
             *
        ...
        R.recipes.findById = function() {
          var TargetResource = $injector.get("Recipe");
          var action = TargetResource["::findById::Account::recipes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Account.recipes#updateById
             * @methodOf lbServices.Account.recipes
             *
             * @description
             *
        ...
        R.recipes.updateById = function() {
          var TargetResource = $injector.get("Recipe");
          var action = TargetResource["::updateById::Account::recipes"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/items/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Recipe.items.createMany() instead.
            "::createMany::Recipe::items": {
              isArray: true,
              url: urlBase + "/recipes/:id/items",
              method: "POST",
            },
        ...
        */
        ...
        R.recipe = function() {
          var TargetResource = $injector.get("Recipe");
          var action = TargetResource["::get::Item::recipe"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/lists/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.List#patchOrCreate
             * @methodOf lbServices.List
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.List#replaceOrCreate
             * @methodOf lbServices.List
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/lists/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.List#upsertWithWhere
             * @methodOf lbServices.List
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/lists/upsertWithWhere",
              method: "POST",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.List#replaceById
             * @methodOf lbServices.List
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.List#prototype$patchAttributes
             * @methodOf lbServices.List
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.List#patchOrCreateWithWhere
             * @methodOf lbServices.List
             *
             * @description
             *
